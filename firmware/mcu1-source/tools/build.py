...
def main():
    ...
    manifest=dict(chip='LPC5528',role='MCU1',target=1,base=0xc000,length=len(image),
        ...
        capabilities=['identity','code_readback','fault_status','boot_start_ack','boot_ack_status','software_recovery','silent_uac2','audio_error_trace','clock_snapshot','dial_display_probe','volume_percent_profile','usb_setup_guard','usb_endpoint_snapshot','mcu2_status_probe','mcu2_probe_trace_v1','mcu2_detect_query_v1','dsp_status_probe','control_uart_snapshot','dsp_passive_capture','dsp_passive_capture_rearm','audio_clock_snapshot','dsp_status_full','headset_telemetry_v1','settings_query_v1','dsp_meter_v1','native_dsp_settings_v1','persistent_mcu2_v1','native_display_settings_v1'],
        ...
        limitations=['USB playback through DSP; microphone remains silent, full lifecycle and audio endurance unqualified',
